...
void cpu_decode_and_execute_cp(GameBoy* gb, uint8_t opcode)
{
    ...
    switch(opcode)
    {
        ...
        case 0x28: /* SRA B */
            ...
            u8Result = (u8Result >> 1U) | (u8Result & 0x80);
        ...
        case 0x30: /* SWAP B */
            ...
            u8Result = (u8Result >> 4U) | (u8Result << 4U);
        ...
        case 0x45: /* BIT 0 L*/
            ...
            break;
        case 0x46: /* BIT 0 (HL)*/
            if(memory_read(gb, cpu_get_hl(&gb->cpu)) & 0x01)
            {
                cpu_clear_z(&gb->cpu);
            }else
            {
        ...
        case 0x4D: /* BIT 1 L*/
            ...
            break;
        case 0x4E: /* BIT 1 (HL)*/
            if(memory_read(gb, cpu_get_hl(&gb->cpu)) & 0x02)
            {
                cpu_clear_z(&gb->cpu);
            }else
            {
        ...
        case 0x55: /* BIT 2 L*/
            ...
            break;
        case 0x56: /* BIT 2 (HL)*/
            if(memory_read(gb, cpu_get_hl(&gb->cpu)) & 0x04)
            {
                cpu_clear_z(&gb->cpu);
            }else
            {
        ...
        case 0x5D: /* BIT 3 L*/
            ...
            break;
        case 0x5E: /* BIT 3 (HL)*/
            if(memory_read(gb, cpu_get_hl(&gb->cpu)) & 0x08)
            {
                cpu_clear_z(&gb->cpu);
            }else
            {
        ...
        case 0x65: /* BIT 4 L*/
            ...
            break;
        case 0x66: /* BIT 4 (HL)*/
            if(memory_read(gb, cpu_get_hl(&gb->cpu)) & 0x10)
            {
                cpu_clear_z(&gb->cpu);
            }else
            {
        ...
        case 0x6D: /* BIT 5 L*/
            ...
            break;
        case 0x6E: /* BIT 5 (HL)*/
            if(memory_read(gb, cpu_get_hl(&gb->cpu)) & 0x20)
            {
                cpu_clear_z(&gb->cpu);
            }else
            {
        ...
        case 0x75: /* BIT 6 L*/
            ...
            break;
        case 0x76: /* BIT 6 (HL)*/
            if(memory_read(gb, cpu_get_hl(&gb->cpu)) & 0x40)
            {
                cpu_clear_z(&gb->cpu);
            }else
            {
        ...
        case 0x7D: /* BIT 7 L*/
            ...
            break;
        case 0x7E: /* BIT 7 (HL)*/
            if(memory_read(gb, cpu_get_hl(&gb->cpu)) & 0x80)
            {
                cpu_clear_z(&gb->cpu);
            }else
            {
